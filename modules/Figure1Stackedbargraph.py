...
for a_dict in json_list:
    ...
    # print(pubyear)
    y_list.append({pubyear: a_dict["getool"]})
...
for year in range(2010, 2023):
    crispr_cas9 = y_list.count({str(year): "CRISPR-Cas9"})
    ...
    talen = y_list.count({str(year): "TALEN"})
    barchart_list.append(
        {
            "category": "TALEN",
            "category_order": 1,
    ...
    cas12 = y_list.count({str(year): "CRISPR-Cas12"})
    barchart_list.append(
        {
    ...
    #     }
    # )
    cas3 = y_list.count({str(year): "CRISPR-Cas3"})
    barchart_list.append(
        {
    ...
    be = y_list.count({str(year): "Base editor"})
    barchart_list.append(
        {
    ...
    pe = y_list.count({str(year): "Prime editor"})
    barchart_list.append(
        {
...
with open(f"../json/metastanza_fig1_{date}.json", "w") as f:
